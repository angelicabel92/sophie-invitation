            ...
            <Row className='ceremory-component align-items-center mt-5 pt-3'>
                ...
                <Col lg='6' className="text-center mb-3">
                    <div className='d-flex align-items-center justify-content-center ceremory-component__date'>
                        <span className="ceremory-component__date--number mb-3">30</span>
                        <span className="ceremory-component__date--month">Agosto <br/> de 2020</span>
                    </div>
                    <p className="ceremory-component__hour">Hora: 10:00 AM</p>
                    <a className="btn btn-lg ceremory-component__btn" href="https://meet.google.com/xeq-nkpp-ozy" target='_blank'>
                        Ir a la capilla</a>
                </Col>
